...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 08 oct. 2024 à 17:32
...
INSERT INTO `carte` (`num_carte`, `client`, `montant`, `date`) VALUES
(1, 'BADIDI DIVIN', 20000, '2024-10-08');
...
(1, 'BADIDI DIVIN', 'M', '243817767357', '000@gmail.com', 'kinshasa', '2024-10-08 07:54:41');
...
CREATE TABLE `paiement_carte` (
  ...
  `client` varchar(100) NOT NULL,
  `montant` int(11) NOT NULL,
  `nbre_pain` int(11) NOT NULL,
  `montant2` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `paiement_carte`
--

INSERT INTO `paiement_carte` (`id_op`, `num_carte`, `client`, `montant`, `nbre_pain`, `montant2`, `bp`, `net`, `date`) VALUES
(1, 1, 'BADIDI DIVIN', 20000, 10, 20000, 0, 5000, '2024-10-08'),
(2, 1, 'BADIDI DIVIN', 20000, 5, 5000, 15000, 1250, '2024-10-08');
...
--
ALTER TABLE `carte`
  MODIFY `num_carte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
