<?php 
    ...
    if (isset($_GET['export001'])==1) {
        header('location:carte_export.php');
    }
    $nav="fournisseur";
 ?>
<!DOCTYPE html>
                        ...
                        <div class="header-wrap">
                            <form class="form-header" action="" method="GET">
                               ...
                               <input type="date" class="au-input"  name="mot2" value="<?php echo ($mot2) ?>"/>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <button class="btn btn-success" title="Exporter vers Excel" name="export001">Excel</button>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="ajout-carte.php" class="btn btn-primary"><i class="zmdi zmdi-plus"></i></a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <a href="./edit-carte.php?dk=<?= $et['num_carte'] ?>" class="btn btn-success">Edit</a>
                                                <a onclick="return confirm('Etes-Vous sûr?')" href="../../controller/carte.php?id=<?= $et['num_carte'] ?>" class="btn btn-danger">Delete</a></td>
                                              <?php  
                                                } ?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="get" action="imprimer_carte.php">
